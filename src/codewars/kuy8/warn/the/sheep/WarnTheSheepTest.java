...
public class WarnTheSheepTest {
    ...
    public void warnTheSheepTest() {
        ...
        assertEquals("Oi! Sheep number 5! You are about to be eaten by a wolf!",
                WarnTheSheep.warnTheSheep(new String[]{"sheep", "wolf", "sheep", "sheep", "sheep", "sheep", "sheep"}));
        assertEquals("Oi! Sheep number 6! You are about to be eaten by a wolf!",
                WarnTheSheep.warnTheSheep(new String[]{"wolf", "sheep", "sheep", "sheep", "sheep", "sheep", "sheep"}));
        assertEquals("Oi! Sheep number 1! You are about to be eaten by a wolf!",
                WarnTheSheep.warnTheSheep(new String[]{"sheep", "wolf", "sheep"}));
        assertEquals("Pls go away and stop eating my sheep",
                WarnTheSheep.warnTheSheep(new String[]{"sheep", "sheep", "wolf"}));
    }
}