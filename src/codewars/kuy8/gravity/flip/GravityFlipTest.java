...
public class GravityFlipTest {
    private static final int[] INPUT = {20, 32, 44, 24, 15, 20, 18, 49, 43, 38, 44, 31, 40, 41, 28, 44, 33, 7, 46, 45, 1, 15, 49, 13, 10, 5,
            22, 22, 44, 21, 47, 20, 1, 41, 5, 41};
    private static final int[] OUTPUT = {1, 1, 5, 5, 7, 10, 13, 15, 15, 18, 20, 20, 20, 21, 22, 22, 24, 28, 31, 32, 33, 38, 40, 41, 41, 41,
            43, 44, 44, 44, 44, 45, 46, 47, 49, 49};


    @Test
    public void flipWithForLoopTest() {
    ...
    @Test
    public void flipWithCollectionsTest() {
    ...
    @Test
    public void flipWithComparatorTest() {
